...
const GramsToPoundsMain = (props) => {
  ...
  useEffect(() => {
    updateUnits("gram", "pound");
  }, []);

  return (
    <main>
      <h2>GRAMS / POUNDS CONVERTER</h2>
      ...
      <div className="description">
        <p className="paragraph">
          Use this calculator to convert between grams and pounds.
        </p>
