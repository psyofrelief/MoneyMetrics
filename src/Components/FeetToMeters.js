...
const FeetToMetersMain = (props) => {
  ...
  useEffect(() => {
    updateUnits("foot", "meter");
  }, []);

  return (
    <main>
      <h2>FEET / METERS CONVERTER</h2>
      ...
      <div className="description">
        <p className="paragraph">
          Use this calculator to convert between feet and meters.
        </p>
